...
@qasm2.extended
def pauli_basis_change(targets: ilist.IList[qasm2.types.Qubit, Any], start: str, end: str):
...
@qasm2.extended
def pauli_exponential(targets: ilist.IList[qasm2.types.Qubit, Any], pauli: str, gamma: float):
