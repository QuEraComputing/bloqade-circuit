...
# Assuming your new CliffordValidation pass is located in the validation module
from bloqade.cirq_utils.validation import CliffordValidation
...
def emit_circuit(
    ...
    # Execute both validation passes seamlessly via the new architecture
    ValidationSuite([CirqClassicalControlValidation, CliffordValidation]).validate(mt_).raise_if_invalid()
