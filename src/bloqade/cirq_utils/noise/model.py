...
class GeminiOneZoneNoiseModel_v1(cirq.NoiseModel):
    """
    A Cirq-compatible noise model for a one-zone implementation of the Gemini architecture.
    ...
    def noisy_moments(
        self, moments: Iterable[cirq.Moment], system_qubits: Sequence[cirq.Qid], parallelize_circuit: bool = False
        ...
        return self._noisy_moments_impl_moment(compressed_circuit.moments, system_qubits)
